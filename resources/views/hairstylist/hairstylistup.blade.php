...
@section('title', 'Повышающий курс по стрижкам для парикмахеров в Алматы| Школа Indigo')
...
@section('content')
    ...
    @include('partials.coursesingup', [
        'title' => 'Почему вам стоит записаться на повышающий курс по стрижкам в школе indigo:',
        'count' => '8',
    ])
