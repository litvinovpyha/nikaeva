...
@section('title', 'Курс женских стрижек и колористики в Алматы — обучение с нуля до профи | Академия NikaEva')
...
@endsection
@section('content')
    <x-hero-section title="КУРС ЖЕНСКИХ СТРИЖЕК И КОЛОРИСТИКИ В АЛМАТЫ - ОБУЧЕНИЕ С НУЛЯ"
    ...
    @include('partials.coursesingup', [
        'title' => 'Почему вам стоит записаться на курс женских стрижек и колористики в академии NikaEva:',
        'count' => '8',
    ])
