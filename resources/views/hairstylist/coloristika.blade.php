...
@section('title', 'Курс колориста в Алматы — обучение колористике с нуля до профи | Академия NikaEva')
...
@section('meta_keywords','курс колориста Алматы, обучение колористике, курсы колористики, академия парикмахеров, колористика база и повышение, обучение парикмахеров Алматы
')
...
@section('content')
    ...
    @include('partials.coursesingup', [
        'title' => 'Почему вам стоит записаться на курс колориста в академии NikaEva:',
        'count' => '8',
    ])
