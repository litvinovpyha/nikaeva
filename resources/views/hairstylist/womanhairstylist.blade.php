...
@section('title', 'Курс «Женский мастер-колорист» в Алматы — обучение с нуля до профи | Академия NikaEva')

@section('meta_description', 'Обучение для женских мастеров-колористов в Алматы: коммерческие стрижки, колористика, укладки и завивки. Практика на моделях, диплом и сертификат за 2 месяца. Скидки до 30%!')



@section('meta_keywords',
    'Обучение для женских мастеров-колористов в Алматы: коммерческие стрижки, колористика, укладки и завивки. Практика на моделях, диплом и сертификат за 2 месяца. Скидки до 30%!')
...
@endsection
@section('content')
    <x-hero-section title="КУРС ЖЕНСКИЙ МАСТЕР - КОЛОРИСТ В АЛМАТЫ - ОБУЧЕНИЕ С НУЛЯ ДО ПРОФИ"
                    ...
                    <li class="right-li">
                        ...
                        <div class="pt-4 border-t border-gray-200">
                            ...
                            <span class="pb-2 mt-2 text-sm text-gray-500">12 коммерческих женских экспресс-стрижек по
                                авторским схемам — легко освоите даже без опыта, влючающие: каскадные формы, каре, пикси и
                                ровная длина
    ...
    @include('partials.coursesingup', [
        'title' => 'Почему вам стоит записаться на курс женского мастера в академии NikaEva:',
        'count' => '8',
    ])
