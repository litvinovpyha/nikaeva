...
@section('title', 'Курс «Женский мастер-колорист» в Алматы — обучение с нуля до профи | Школа Indigo')
...
@section('content')
    ...
    @include('partials.coursesingup', [
        'title' => 'Почему вам стоит записаться на курс женского мастера в школе indigo:',
        'count' => '8',
    ])
