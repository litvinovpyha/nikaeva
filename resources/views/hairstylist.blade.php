...
@section('title', 'Все курсы парикмахеров в Алматы — обучение с нуля | Школа Indigo')

@section('meta_description','Онлайн и офлайн обучение, сертификаты, практика. Запишитесь сейчас и получите скидку до 40%')
