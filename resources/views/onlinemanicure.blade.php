...
@section('title', 'Онлайн курсы маникюра и педикюра — обучение с нуля с сертификатом | NikaEva')

@section('meta_description', 'Проходи онлайн-обучение маникюру и педикюру с нуля. Изучай современные техники: классическую, аппаратную и комбинированную. Получи сертификат и начни зарабатывать от 400 000 ₸ уже через 2 месяца. Обучение от академии NikaEva.')

@section('meta_keywords', 'онлайн курс маникюра, обучение педикюру онлайн, курсы маникюра с сертификатом, маникюр и педикюр с нуля, академия NikaEva, курсы красоты, комбинированный маникюр')
    ...
    <script type="application/ld+json">
{
  ...
  "@graph": [
    ...
    },
    {
           "@type": "Course",
      "name": "Онлайн курс маникюра Идеальный комбинированный + аппаратный",
      "description": "Обучение маникюра Идеальный комбинированный + аппаратный. Онлайн курс,Без Диплома, старт карьеры с NikaEva.",
      "provider": {
        "@type": "Organization",
        "name": "NikaEva",
        "url": "{{ url('/') }}"
