...
@section('content')
<x-hero-section title="КУРСЫ ПАРИКМАХЕРОВ, КОЛОРИСТОВ И МАСТЕРОВ МАНИКЮРА В АЛМАТЫ" subtitle="КРЕПКИЙ ФУНДАМЕНТ ВАШИХ ЗНАНИЙ" subsubtitle="СКИДКА ДО -30% НА ОБУЧЕНИЕ" />
    ...
    <div class="grid items-center gap-6 sm:grid-cols-2 lg:grid-cols-3 md:gap-10">
        <div class="p-5 bg-white rounded-lg shadow-lg size-full ">
            <div class="flex items-center mb-3 gap-x-4">
                <div class="inline-flex justify-center items-center size-15.5 rounded-full border-4 border-blue-50 bg-blue-100 ">
                    <svg class="text-indigo-600 shrink-0 size-6 " xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">>
        ...
        <div class="p-5 bg-white rounded-lg shadow-lg size-full ">
            ...
            <p class="text-gray-600 ">Престижный сертификат, помощь тренера и содействие в трудоустройстве.
            </p>
        </div>
    </div>
</div>
...
<div class="relative py-16 overflow-hidden bg-gray-900 isolate sm:py-24 lg:py-32">
        ...
        <div class="grid max-w-2xl grid-cols-1 mx-auto gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
            ...
            <div class="max-w-xl lg:max-w-lg">
                ...
                <div class="flex flex-col max-w-md gap-4 mt-6 sm:flex-row">
                    ...
                    <a href="{{ route('callback') }}" class="rounded-md bg-indigo-700 px-4 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-indigo-400 focus:outline-none focus:ring-2 focus:ring-indigo-500">
                        ОСТАВИТЬ ЗАЯВКУ
                    </a>
                </div>
            </div>
    ...
    <div class="absolute top-0 -translate-x-1/2 left-1/2 -z-10 blur-3xl xl:-top-6" aria-hidden="true">
        <div class="aspect-1155/678 w-288.75 bg-gradient-to-tr from-[#ff80b5] to-[#9089fc] opacity-30" style="clip-path: polygon(74.1% 44.1%, 100% 61.6%, 97.5% 26.9%, 85.5% 0.1%, 80.7% 2%, 72.5% 32.5%, 60.2% 62.4%, 52.4% 68.1%, 47.5% 58.3%, 45.2% 34.5%, 27.5% 76.7%, 0.1% 64.9%, 17.9% 100%, 27.6% 76.8%, 76.1% 97.7%, 74.1% 44.1%)">
        </div>
    </div>
</div>
    ...
    <div class="mx-auto max-w-7xl">
        <div class="max-w-2xl mx-auto lg:max-w-none sm:py-24 lg:py-32">
            <div class="grid grid-cols-1 mt-6 gap-y-6 sm:grid-cols-2 lg:grid-cols-4 lg:gap-x-6">
                ...
                <a href="{{ route($item['route']) }}" class="group relative p-2 rounded-lg flex flex-col h-full {{ $index % 2 === 0 ? 'bg-white' : 'bg-gray-200' }}">
                    <h2 class="mb-2 text-2xl font-semibold text-center text-gray-900 uppercase">
                        {{ $item['title'] }}
                    </h2>
                    <div class="mt-auto">
                        <img src="{{ asset($item['img']) }}" alt="" class="object-cover w-full rounded-lg no-modal group-hover:opacity-75 max-sm:h-80 sm:aspect-2/1 lg:aspect-square">
                    </div>
                </a>
                @endforeach
            </div>
...
<div class="max-w-[85rem] px-4 py-10 sm:px-6 lg:px-8 lg:py-14 mx-auto">
    <h2 class="text-3xl font-bold tracking-tight text-center text-gray-900 uppercase sm:text-4xl">
        НАШИ УЧЕНИКИ ПО ВСЕМУ МИРУ
    </h2>

    <div class="mt-10">
        <img src="{{ asset('images/map.png') }}" alt="Карта мира" class="w-full h-auto object-contain">
    </div>
</div>
    ...
    <div class="mx-auto max-w-7xl">
        <div id="accordion-collapse" data-accordion="collapse" class="mt-5">
            <h3 id="accordion-collapse-heading-10">
                <button type="button" class="flex items-center justify-between w-full gap-3 p-5 font-medium text-white bg-gray-800 rtl:text-right" data-accordion-target="#accordion-collapse-body-10" aria-expanded="true" aria-controls="accordion-collapse-body-10">
    ...
    <div class="mx-auto max-w-7xl">
        <div id="accordion-collapse" data-accordion="collapse" class="mt-5">
            <h3 id="accordion-collapse-heading-11">
                <button type="button" class="flex items-center justify-between w-full gap-3 p-5 font-medium text-white bg-gray-800 rtl:text-right" data-accordion-target="#accordion-collapse-body-11" aria-expanded="true" aria-controls="accordion-collapse-body-11">
    ...
    <div class="mx-auto max-w-7xl">
        <div id="accordion-collapse" data-accordion="collapse" class="mt-5">
            <h3 id="accordion-collapse-heading-12">
                <button type="button" class="flex items-center justify-between w-full gap-3 p-5 font-medium text-white bg-gray-800 rtl:text-right" data-accordion-target="#accordion-collapse-body-12" aria-expanded="true" aria-controls="accordion-collapse-body-12">
    ...
    <div class="mx-auto max-w-7xl">
        <div id="accordion-collapse" data-accordion="collapse" class="mt-5">
            <h3 id="accordion-collapse-heading-13">
                <button type="button" class="flex items-center justify-between w-full gap-3 p-5 font-medium text-white bg-gray-800 rtl:text-right" data-accordion-target="#accordion-collapse-body-13" aria-expanded="true" aria-controls="accordion-collapse-body-13">
    ...
    <div class="mx-auto max-w-7xl">
        <div id="accordion-collapse" data-accordion="collapse" class="mt-5">
            <h3 id="accordion-collapse-heading-14">
                <button type="button" class="flex items-center justify-between w-full gap-3 p-5 font-medium text-white bg-gray-800 rtl:text-right" data-accordion-target="#accordion-collapse-body-14" aria-expanded="true" aria-controls="accordion-collapse-body-14">
