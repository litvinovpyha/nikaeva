...
@section('title', 'Повышающий курс Аппаратный и комбинированный маникюр + Архитектура ногтей в Алматы | Академия NikaEva')
...
@section('content')
    <x-hero-section title="Повышающий курс Аппаратный и комбинированный маникюр + Архитектура ногтей"
        subtitle="Обучение для действующих мастеров. Диплом NikaEva, практика и скидка до -30%"
    ...
    @include('partials.coursesingup', [
        'title' =>
            'Почему вам стоит записаться на курс повышающий Аппаратный и комбинированный маникюр в академии NikaEva:',
        'count' => '5',
    ])
