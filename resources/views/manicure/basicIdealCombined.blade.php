...
@section('title','Базовый курс маникюра "Идеальный комбинированный" в Алматы | Школа Indigo')
@section('meta_description', 'Базовый курс маникюра "Идеальный комбинированный" в Алматы. Освойте коммерческие техники маникюра с нуля, получите диплом и практику на моделях. Начало карьеры с Indigo!')
@section('meta_keywords', 'базовый курс маникюра Алматы, идеальный комбинированный маникюр обучение, курсы маникюра с дипломом, маникюр с нуля Indigo, обучение ногтевому сервису')
...
<script type="application/ld+json">
{
  ...
  "description": "Обучение идеальному комбинированному маникюру. 2 ключевые техники для начинающих, диплом Indigo и практика на моделях. Идеальное начало карьеры мастера.",
  "provider": {
    "@type": "Organization",
    "name": "Indigo",
    "url": "{{ url('/') }}"
...
@section('content')
    ...
    @include('partials.coursesingup', [
        'title' => 'Почему вам стоит записаться на базовый курс маникюра и педикюра идеальный комбинированныйв школе indigo:',
        'count' => '5',
    ])
