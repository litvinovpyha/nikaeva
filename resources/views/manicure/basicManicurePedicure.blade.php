...
@section('title','Базовый курс маникюра и педикюра в Алматы | Школа Indigo')
@section('meta_description', 'Базовый курс маникюра и педикюра в Алматы. Обучение с нуля: комбинированные и аппаратные техники, педикюр. Диплом, сертификат и практика в школе Indigo.')
@section('meta_keywords', 'базовый курс маникюра Алматы, обучение педикюру, курсы маникюра и педикюра, Indigo курсы ногтевого сервиса')
...
<script type="application/ld+json">
{
  ...
  "description": "Базовое обучение маникюру и педикюру. Освоите комбинированные и аппаратные техники, научитесь делать педикюр. С дипломом Indigo и практикой на моделях.",
  "provider": {
    "@type": "Organization",
    "name": "Indigo",
    "url": "{{ url('/') }}"
...
@section('content')
    ...
    @include('partials.coursesingup', [
        'title' => 'Почему вам стоит записаться на базовый курс маникюра и педикюраа в школе indigo:',
        'count' => '5',
    ])
