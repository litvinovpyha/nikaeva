...
@section('title','Базовый курс маникюра и педикюра в Алматы | Академия NikaEva')
@section('meta_description', 'Базовый курс маникюра и педикюра в Алматы. Обучение с нуля: комбинированные и аппаратные техники, педикюр. Диплом, сертификат и практика в академии NikaEva.')
@section('meta_keywords', 'базовый курс маникюра Алматы, обучение педикюру, курсы маникюра и педикюра, NikaEva курсы ногтевого сервиса')
...
<script type="application/ld+json">
{
  ...
  "description": "Базовое обучение маникюру и педикюру. Освоите комбинированные и аппаратные техники, научитесь делать педикюр. С дипломом NikaEva и практикой на моделях.",
  "provider": {
    "@type": "Organization",
    "name": "NikaEva",
    "url": "{{ url('/') }}"
...
@section('content')
    ...
    @include('partials.coursesingup', [
        'title' => 'Почему вам стоит записаться на базовый курс маникюра и педикюраа в академии NikaEva:',
        'count' => '5',
    ])
