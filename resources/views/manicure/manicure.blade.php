...
@section('title','Все курсы маникюра и дизайна ногтей в Алматы | Академия NikaEva')
@section('meta_description', "Обучение маникюру, педикюру и дизайну ногтей с нуля до топ-мастера за 2 недели. Диплом, сертификат, практика, скидка до 30%. Начни карьеру уже сегодня в Алматы!")
@section('meta_keywords', 'курс маникюра Алматы, обучение педикюру, дизайн ногтей, курсы ногтевого сервиса, диплом маникюра, курсы маникюра с нуля, NikaEva маникюр')
@section('jsonld')
          ...
          "@graph": [
            {
              ...
              "description": "Обучение идеального комбинированного маникюра. 2 коммерческие техники маникюра, С Дипломом, старт карьеры с NikaEva.",
              "provider": {
                "@type": "Organization",
                "name": "NikaEva",
                "url": "{{ url('/') }}"
    ...
    },
    {
      ...
      "description": "Интенсивное обучение идеального комбинированного и аппаратного маникюра. 3 ключевые техники, С Дипломом, старт карьеры с NikaEva.",
      "provider": {
        "@type": "Organization",
        "name": "NikaEva",
        "url": "{{ url('/') }}"
    ...
    },
     {
      ...
      "description": "Обучение маникюра и педикюра. 3 ключевые техники + педикюр, С Дипломом, старт карьеры с NikaEva.",
      "provider": {
        "@type": "Organization",
        "name": "NikaEva",
        "url": "{{ url('/') }}"
      ...
      "description": "Интенсивный обучение маникюра и педикюра. 3 ключевые техники + педикюр, С Дипломом, старт карьеры с NikaEva.",
      "provider": {
        "@type": "Organization",
        "name": "NikaEva",
        "url": "{{ url('/') }}"
      ...
      "description": "Обучение 3 в 1 NAIL STYLIST Маникюр, Педикюр, Моделирование ногтей. 3 ключевые техники + педикюр, С Дипломом, старт карьеры с NikaEva.",
      "provider": {
        "@type": "Organization",
        "name": "NikaEva",
        "url": "{{ url('/') }}"
      ...
      "description": "Обучение Японский маникюр, экоглянцевание. Идеальное решение, если вы уже делаете маникюр, С Дипломом, старт карьеры с NikaEva.",
      "provider": {
        "@type": "Organization",
        "name": "NikaEva",
        "url": "{{ url('/') }}"
      ...
      "description": "Обучение эстетического педикюра в аппаратной технике . Идеальное решение, если вы уже делаете педикюр, С Дипломом, старт карьеры с NikaEva.",
      "provider": {
        "@type": "Organization",
        "name": "NikaEva",
        "url": "{{ url('/') }}"
      ...
      "description": "Обучение Аппаратный и комбинированный маникюр + Архитектура ногтей. Идеальное решение, если вы уже действующий мастер, С Дипломом, старт карьеры с NikaEva.",
      "provider": {
        "@type": "Organization",
        "name": "NikaEva",
        "url": "{{ url('/') }}"
      ...
      "description": "Обучение Моделирование ногтей на верхние формы. Идеальное решение, если вы уже опытный мастер, С Дипломом, старт карьеры с NikaEva.",
      "provider": {
        "@type": "Organization",
        "name": "NikaEva",
        "url": "{{ url('/') }}"
  ...
  "mainEntity": [
    {
      "@type": "Question",
      "name": "Кому подойдут курсы маникюра и педикюра в NikaEva?",
      "acceptedAnswer": {
        "@type": "Answer",
    ...
    },
    {
      ...
      "acceptedAnswer": {
        "@type": "Answer",
        "text": "Да, после завершения курса вы получаете диплом NikaEva, подтверждающий вашу квалификацию."
      }
    }
  ]
}
...
@section('content')
    <x-hero-section
        ...
        subtitle="ОБУЧАЕМ С НУЛЯ ДО ТОП-МАСТЕРА ЗА 2 недели. СЕРТИФИКАТ, ПРАКТИКА И СКИДКА ДО -30%"
            ...
            <div>
                ...
                <ul class="grid grid-cols-1 mt-3 lg:grid-cols-2 gap-x-6 gap-y-3 lg:gap-x-8 ">
                    ...
                    <li class="right-dl">
                        ...
                        <div class="pt-4 border-gray-200">
                            <p class="font-medium text-gray-900">Маникюр — 2 ключевые техники, которые приносят
                                доход:</p>
                            <ul class="pt-4 pl-5 text-sm text-gray-500 list-disc">
                                <li>Комбинированный одной фрезой + щипчики / ножнички — для плотной и чистой обработки
                                </li>
