...
@section('title','Повышающий курс Японский маникюр и эко глянцевание в Алматы | Школа Indigo')
@section('meta_description', 'Обучение японскому маникюру и эко глянцеванию в Алматы. Повышающий курс для мастеров, диплом Indigo, сертификат, практика, скидка до 30%.')
@section('meta_keywords', 'японский маникюр Алматы, эко глянцевание, курс японского маникюра, повышение квалификации маникюр, Indigo маникюр')
...
<script type="application/ld+json">
{
  ...
  "@type": "Course",
  "name": "Повышающий курс Японский маникюр и эко глянцевание в Алматы",
  "description": "Повышающий курс для мастеров. Обучение японскому маникюру и эко глянцеванию в Алматы. Диплом Indigo, практика и скидка до 30%.",
  "provider": {
    "@type": "Organization",
    "name": "Indigo",
    "url": "{{ url('/') }}"
...
@section('content')
    <x-hero-section
        title="Повышающий курс — Японский маникюр и эко глянцевание"
        subtitle="Современные техники ухода за ногтями. Диплом Indigo, сертификат и практика"
    ...
    @include('partials.coursesingup', [
        'title' => 'Почему вам стоит записаться на Повышающий курс Японский маникюр и эко глянцевание в школе indigo:',
        'count' => '5',
    ])
