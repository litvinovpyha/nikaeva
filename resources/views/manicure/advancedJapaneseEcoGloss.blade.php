...
@section('title','Повышающий курс Японский маникюр и экоглянцевание в Алматы | Школа Indigo')
@section('meta_description', 'Обучение японскому маникюру и экоглянцеванию в Алматы. Повышающий курс для мастеров, диплом Indigo, сертификат, практика, скидка до 30%.')
@section('meta_keywords', 'японский маникюр Алматы, экоглянцевание, курс японского маникюра, повышение квалификации маникюр, Indigo маникюр')
...
<script type="application/ld+json">
{
  ...
  "description": "Повышающий курс для мастеров. Обучение японскому маникюру и экоглянцеванию в Алматы. Диплом Indigo, практика и скидка до 30%.",
  "provider": {
    "@type": "Organization",
    "name": "Indigo",
    "url": "{{ url('/') }}"
...
@section('content')
    ...
    @include('partials.coursesingup', [
        'title' => 'Почему вам стоит записаться на Повышающий курс Японский маникюр и экоглянцевание в школе indigo:',
        'count' => '5',
    ])
