...
@section('title','Интенсивный курс маникюра: идеальный комбинированный + аппаратный в Алматы | Школа Indigo')
@section('meta_description', 'Интенсивный курс маникюра в Алматы: идеальный комбинированный и аппаратный. Обучение за короткий срок с практикой, дипломом и сертификатом. Старт карьеры с Indigo.')
@section('meta_keywords', 'интенсивный курс маникюра Алматы, комбинированный маникюр обучение, аппаратный маникюр курсы, курсы Indigo, маникюр для начинающих')
...
<script type="application/ld+json">
{
  ...
  "description": "Интенсивное обучение маникюру: идеальный комбинированный и аппаратный. Освойте ключевые техники, получите диплом Indigo и практику на моделях. Старт карьеры уже сегодня!",
  "provider": {
    "@type": "Organization",
    "name": "Indigo",
    "url": "{{ url('/') }}"
...
@section('content')
    ...
    @include('partials.coursesingup', [
        'title' => 'Почему вам стоит записаться на интенсивный курс маникюра в школе indigo:',
        'count' => '5',
    ])
