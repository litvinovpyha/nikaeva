...
@section('title','Интенсивный курс маникюра: идеальный комбинированный + аппаратный в Алматы | Академия NikaEva')
@section('meta_description', 'Интенсивный курс маникюра в Алматы: идеальный комбинированный и аппаратный. Обучение за короткий срок с практикой, дипломом и сертификатом. Старт карьеры с NikaEva.')
@section('meta_keywords', 'интенсивный курс маникюра Алматы, комбинированный маникюр обучение, аппаратный маникюр курсы, курсы NikaEva, маникюр для начинающих')
...
<script type="application/ld+json">
{
  ...
  "@type": "Course",
  "name": "Интенсивный курс маникюра: идеальный комбинированный + аппаратный в Алматы",
  "description": "Интенсивное обучение маникюру: идеальный комбинированный и аппаратный. Освойте ключевые техники, получите диплом NikaEva и практику на моделях. Старт карьеры уже сегодня!",
  "provider": {
    "@type": "Organization",
    "name": "NikaEva",
    "url": "{{ url('/') }}"
...
@section('content')
    <x-hero-section
        title="ИНТЕНСИВНЫЙ КУРС МАНИКЮРА В АЛМАТЫ"
        subtitle="Идеальный комбинированный + аппаратный маникюр"
        subsubtitle="Диплом • Сертификат • Практика • Скидка до -30%"
    />
    ...
    @include('partials.coursesingup', [
        'title' => 'Почему вам стоит записаться на интенсивный курс маникюра в академии NikaEva:',
        'count' => '5',
    ])
