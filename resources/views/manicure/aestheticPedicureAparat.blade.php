...
@section('title', 'Курс эстетического педикюра в аппаратной технике в Алматы | Школа Indigo')
@section('meta_description', 'Обучение эстетическому педикюру в аппаратной технике. Диплом, сертификат, практика, скидка
    до 30% в Алматы.')
@section('meta_keywords', 'курс педикюра Алматы, эстетический педикюр, аппаратный педикюр, курсы педикюра Indigo,
    обучение педикюру')
    ...
    <script type="application/ld+json">
{
  ...
  "description": "Обучение эстетического педикюра в аппаратной технике. Идеальное решение для действующих мастеров. Диплом Indigo, практика и скидка до 30%.",
  "provider": {
    "@type": "Organization",
    "name": "Indigo",
    "url": "{{ url('/') }}"
...
@section('content')
    <x-hero-section title="Курс эстетического педикюра в аппаратной технике"
        subtitle="Обучение для мастеров, желающих повысить квалификацию. Диплом Indigo, практика и скидка до -30%"
        subsubtitle="— Освой новые техники вместе с Indigo!" />
    ...
    @include('partials.coursesingup', [
        'title' => 'Почему вам стоит записаться на курс эстетического педикюра в аппаратной технике  в школе indigo:',
        'count' => '5',
    ])
