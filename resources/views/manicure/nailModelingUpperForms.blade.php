...
@section('title','Курс моделирования ногтей на верхние формы в Алматы | Академия NikaEva')
@section('meta_description', "Повышающий курс моделирования ногтей на верхние формы. Научись создавать идеальные ногти, отработай практику и получи диплом NikaEva в Алматы.")
@section('meta_keywords', 'курсы моделирования ногтей Алматы, обучение верхние формы, курс наращивания ногтей, диплом ногтевого сервиса, NikaEva курсы ногтей')
      ...
      "mainEntity": [
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Вы освоите технику работы с верхними формами, научитесь быстро и качественно моделировать ногти, получите диплом NikaEva."
          }
        },
        {
          "@type": "Question",
        ...
        },
        {
          ...
          "acceptedAnswer": {
            "@type": "Answer",
            "text": "Да, вы получаете диплом NikaEva, который подтверждает вашу квалификацию и даёт возможность работать в салонах или на себя."
          }
        }
      ]
    }
...
@section('content')
    <x-hero-section
        ...
        subtitle="ПОВЫШЕНИЕ КВАЛИФИКАЦИИ ДЛЯ МАСТЕРОВ С ДИПЛОМОМ NIKAEVA"
    ...
    @include('partials.coursesingup', [
        'title' => 'Почему вам стоит записаться на курс моделирования ногтей на верхние формы в академии NikaEva:',
        'count' => '5',
    ])
