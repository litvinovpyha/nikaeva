...
@section('title','Интенсивный курс маникюра и педикюра в Алматы | Академия NikaEva')
...
@section('meta_keywords', 'интенсивный курс маникюра Алматы, обучение педикюру, курсы маникюра и педикюра, NikaEva курсы ногтевого сервиса')
...
<script type="application/ld+json">
{
  ...
  "description": "Интенсивное обучение маникюру и педикюру: комбинированные и аппаратные техники, моделирование, практика на моделях. С дипломом NikaEva и возможностью карьерного роста.",
  "provider": {
    "@type": "Organization",
    "name": "NikaEva",
    "url": "{{ url('/') }}"
...
@section('content')
    <x-hero-section
        ...
        subtitle="Обучение с нуля до топ-мастера за 2 недели"
    ...
    @include('partials.coursesingup', [
        'title' => 'Почему вам стоит записаться на интенсивный курс маникюра и педикюра  а в академии NikaEva:',
        'count' => '5',
    ])
