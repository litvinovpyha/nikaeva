...
@section('title', 'Бесплатный курс «Лёгкий старт» — Как найти своё предназначение, личный бренд, сервис | NikaEva')
@section('meta_description', 'Откройте бесплатный демо-курс «Лёгкий старт» от NikaEva: уроки о том, как найти своё предназначение, ставить цели, строить личный бренд и работать с клиентами.')
@section('meta_keywords', 'бесплатный курс предназначение, курс постановка целей, курс личный бренд, сервис и продажи обучение, NikaEva бесплатно')
...
<script type="application/ld+json">
{
  ...
  "description": "Бесплатный демо-курс NikaEva: как найти своё предназначение, постановка целей, продажи и сервис, личный бренд.",
  "provider": {
    "@type": "Organization",
    "name": "NikaEva",
    "url": "{{ url('/') }}"
