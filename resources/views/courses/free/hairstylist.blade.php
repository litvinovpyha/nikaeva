...
@section('meta_description', 'Смотрите бесплатные видео уроки демо-курса парикмахера-колориста от Indigo. Освойте базу стрижек и колористики онлайн — начните карьеру бесплатно.')
@section('meta_keywords', 'бесплатный курс парикмахера, демо курс парикмахера, обучение парикмахеров бесплатно, онлайн курс колориста бесплатно')
...
<div class="max-w-5xl px-4 py-12 mx-auto">
    <h1 class="mb-4 text-4xl font-bold text-gray-900">Бесплатный демо-курс парикмахера-колориста</h1>
    <p class="mb-10 text-lg text-gray-700">
        Откройте доступ к бесплатным видео-урокам. Узнайте основы стрижек, окрашивания и ухода за волосами — пройдите демо-курс прямо сейчас!
    </p>

    <div class="space-y-12">
        <!-- Урок 1 -->
        <div>
            <h2 class="mb-4 text-2xl font-semibold text-indigo-600">Урок 1: Стартовый набор инстурментов</h2>
        ...
        <!-- Урок 2 -->
        <div>
            <h2 class="mb-4 text-2xl font-semibold text-indigo-600">Урок 2: Как держать ножницы</h2>
            <div class="aspect-w-16 aspect-h-9">
        ...
        <!-- Урок 3 -->
        <div>
            <h2 class="mb-4 text-2xl font-semibold text-indigo-600">Урок 3: Классическое разделение на зоны</h2>
            <div class="aspect-w-16 aspect-h-9">
        ...
        <!-- Урок 4 -->
        <div>
            <h2 class="mb-4 text-2xl font-semibold text-indigo-600">Урок 4: Техника стрижки "Ровная длина"</h2>
            <div class="aspect-w-16 aspect-h-9">
        ...
        <!-- Урок 5 -->
        <div>
            <h2 class="mb-4 text-2xl font-semibold text-indigo-600">Урок 5: Коммерческий каскад</h2>
            <div class="aspect-w-16 aspect-h-9">
        ...
        <!-- Урок 6 -->
        <div>
            <h2 class="mb-4 text-2xl font-semibold text-indigo-600">Урок 6: Укладка феном</h2>
            <div class="aspect-w-16 aspect-h-9">
        ...
        <!-- Урок 7 -->
        <div>
            <h2 class="mb-4 text-2xl font-semibold text-indigo-600">Урок 7: Стрижка каскад на длинный волос</h2>
            <div class="aspect-w-16 aspect-h-9">
        ...
        <!-- Урок 8 -->
        <div>
            <h2 class="mb-4 text-2xl font-semibold text-indigo-600">Урок 8: Техника вторичного окрашивания</h2>
            <div class="aspect-w-16 aspect-h-9">
        ...
        {{-- <div>
            ...
            <div class="aspect-w-16 aspect-h-9">
                <iframe src="https://www.youtube.com/embed/" class="w-full h-full rounded-lg"
                        title=" демо" frameborder="0" allowfullscreen></iframe>
            </div>
        </div> --}}
        <!-- CTA -->
