...
@section('title', 'Бесплатный демо-курс парикмахера-колориста онлайн — NikaEva')
@section('meta_description',
    'Смотрите бесплатные видео уроки демо-курса парикмахера-колориста от NikaEva. Освойте базу
    ...
    <script type="application/ld+json">
{
  ...
  "description": "Смотрите демо-уроки по стрижкам и колористике бесплатно. Начните карьеру парикмахера онлайн с NikaEva.",
  "provider": {
    "@type": "Organization",
    "name": "NikaEva",
    "url": "{{ url('/') }}"
