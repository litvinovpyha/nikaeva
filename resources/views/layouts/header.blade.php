            ...
            @auth
                ...
                <div class="relative">
                    <button id="userMenuButton" type="button" aria-label="Open user menu" role="button"
                        class="flex items-center font-semibold text-white gap-x-1 text-sm/6" onclick="toggleUserMenu()">
                        ...
                        <div role="menu">
                            @if (Auth::user()->role == 'admin')
                                ...
                                <div
                                    ...
                                    <div class="flex-auto">
                                        <a href="{{ route('courses.index') }}" class="block font-semibold text-gray-900">
                                            Все Курсы
                                            <span class="absolute inset-0"></span>
                                        </a>
                                    </div>
                                ...
                                <div
                                    ...
                                    <div class="flex-auto">
                                        <a href="{{ route('lessons.index') }}" class="block font-semibold text-gray-900">
                                            Все Уроки
                                            <span class="absolute inset-0"></span>
                                        </a>
                                    </div>
                                ...
                                <div
                                    ...
                                    <div class="flex-auto">
                                        <a href="{{ route('courses.create') }}" class="block font-semibold text-gray-900">
                                            Создать Курс
                                            <span class="absolute inset-0"></span>
                                        </a>
                                    </div>
                                ...
                                <div
                                    ...
                                    <div class="flex-auto">
                                        <a href="{{ route('lessons.create') }}" class="block font-semibold text-gray-900">
                                            Создать Урок
                                            <span class="absolute inset-0"></span>
                                        </a>
                                    </div>
                            ...
                            <div class="grid grid-cols-2 divide-x divide-gray-900/5 bg-gray-50">
                                <a href="https://www.instagram.com/pokhlebaeva.pro/?igshid=174ro53kwcgg1"
                                    ...
                                    <svg class="flex-none text-gray-400 size-5 lucide lucide-instagram-icon lucide-instagram"
