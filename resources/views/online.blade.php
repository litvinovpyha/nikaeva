...
@section('meta_description',
    'Выбирай онлайн-курсы маникюра, парикмахерского искусства, колористики и ламинирования от
    академии NikaEva. Учись из любой точки, получай сертификат, практикуйся и начинай зарабатывать уже через 2 месяца.')

@section('meta_keywords',
    'онлайн курсы маникюра, обучение парикмахеров онлайн, курсы колористики, курсы ламинирования,
    курсы красоты онлайн, NikaEva академия красоты')
@section('jsonld')
    <script type="application/ld+json">
          ...
          "@graph": [
            {
              ...
              "description": "Обучение маникюра Идеальный комбинированный + аппаратный. Онлайн курс, С Дипломом, старт карьеры с NikaEva.",
              "provider": {
                "@type": "Organization",
                "name": "NikaEva",
                "url": "{{ url('/') }}"
      ...
      "description": "Обучение Ламинирование и ботокс ресниц с нуля. Онлайн курс, Диплом, старт карьеры с NikaEva.",
      "provider": {
        "@type": "Organization",
        "name": "NikaEva",
        "url": "{{ url('/') }}"
    ...
    },
    {
      ...
      "description": "Обучение ламинированию ресниц онлайн. Для мастеров бровистов. С дипломом NikaEva.",
      "provider": {
        "@type": "Organization",
        "name": "NikaEva",
        "url": "{{ url('/') }}"
      ...
      "description": "Онлайн обучение по геометрии стрижек. с Дипломом NikaEva.",
      "provider": {
        "@type": "Organization",
        "name": "NikaEva",
        "url": "{{ url('/') }}"
...
@section('content')
    ...
    <div class="bg-white">
        <div
            ...
            <div class="grid grid-cols-2 grid-rows-2 gap-4 sm:gap-6 lg:gap-8">
                <img src="{{ asset('images/manicure/combi-manicure.webp') }}" alt=""
                    class="bg-gray-100 rounded-lg">
                <img src="{{ asset('images/manicure/japan-manicure.webp') }}" alt=""
                    class="bg-gray-100 rounded-lg">
                <img src="{{ asset('images/manicure/manicure-couse.webp') }}" alt=""
                    class="bg-gray-100 rounded-lg">
                <img src="{{ asset('images/manicure/manicure-pedicure-modeling.webp') }}" alt=""
                    class="bg-gray-100 rounded-lg">
            </div>
    ...
    <div class="bg-white">
        <div
            class="grid items-center max-w-2xl grid-cols-1 px-4 py-24 mx-auto gap-x-8 gap-y-16 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
            <div>
                <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">ДЕМО ОНЛАЙН КУРС ДЛЯ ПАРИКМАХЕРОВ
                </h2>
            ...
            <div class="grid grid-cols-2 grid-rows-2 gap-4 sm:gap-6 lg:gap-8">
                <img src="{{ asset('images/hairstylist/Kommercheskıe-strıjkı.webp') }}" alt=""
                    class="bg-gray-100 rounded-lg">
    ...
    <div class="bg-white">
        <div
            class="grid items-center max-w-2xl grid-cols-1 px-4 py-24 mx-auto gap-x-8 gap-y-16 sm:px-6 sm:py-32 lg:max-w-7xl lg:grid-cols-2 lg:px-8">
            <div>
                <h2 class="text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">ДЕМО ВЕРСИЯ КУРСА МАНИКЮРА </h2>
                ...
                <dl class="grid grid-cols-1 mt-16 gap-x-6 gap-y-10 sm:grid-cols-2 sm:gap-y-16 lg:gap-x-8">
                    <div class="pt-4 border-t border-gray-200">
                        ...
                        <dd class="mt-2 text-sm text-gray-500">
                            Научитесь правильно ставить краткосрочные и долгосрочные цели, которые помогут выстроить
                            успешный старт в сфере бьюти-услуг и маникюра.
                        </dd>
                    </div>
                    ...
                    <div class="pt-4 border-t border-gray-200">
                        ...
                        <dd class="mt-2 text-sm text-gray-500">
                            Узнаете, как создавать безупречный сервис, выстраивать доверие и комфорт для клиентов, чтобы они
                            возвращались снова и снова.
                        </dd>
                    </div>

                    <div class="pt-4 border-t border-gray-200">
                        <dt class="font-medium text-gray-900">Общение с клиентами</dt>
                        <dd class="mt-2 text-sm text-gray-500">
                            Освоите техники эффективного общения: как правильно презентовать услуги, общаться до и после
                            процедуры, работать с возражениями.
                        </dd>
                    </div>

                    <div class="pt-4 border-t border-gray-200">
                        <dt class="font-medium text-gray-900">Продажи</dt>
                        <dd class="mt-2 text-sm text-gray-500">
                            Научитесь продавать свои услуги без навязчивости: использовать техники продвижения, скидки,
                            рекомендации и личный бренд.
                        </dd>
                    </div>
                </dl>
    ...
    <div class="bg-white">
        <div
            ...
            <div class="grid grid-cols-2 grid-rows-2 gap-4 sm:gap-6 lg:gap-8">
                <img src="{{ asset('images/lamination/brow-lami.webp') }}" alt=""
                    class="bg-gray-100 rounded-lg">
                <img src="{{ asset('images/lamination/eyebrowlamination.webp') }}" alt=""
                    class="bg-gray-100 rounded-lg">
                <img src="{{ asset('images/lamination/eyelashlamination.webp') }}" alt=""
                    class="bg-gray-100 rounded-lg">
                <img src="{{ asset('images/lamination/brow-lami.webp') }}" alt=""
                    class="bg-gray-100 rounded-lg">
            </div>
